                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Thêm mới cơ sở</h3></div>
                                    <div class="card-body">
                                        <form method="POST" action="co_so_them_moi_thuc_hien.php" enctype="multipart/form-data">
