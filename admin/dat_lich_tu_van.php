            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                         <h1 class="mt-4">Đặt lịch tư vấn trực tuyến</h1>
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                Danh sách khách hàng đặt lịch tư vấn
                            </div>
                            <div class="card-body">
                                    ...
                                    <tbody>
                                      ...
                                      //4. Hiên thị ra dữ liệu vừa lấy
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center"><input type="checkbox" name="custom-switch-checkbox" class="custom-switch-input"></td>
                                            <td style="text-align: center"><a href="dat_lich_tu_van_xoa.php?id=<?php echo $row["id_lien_he"];?>">Xóa</a></td>
                                        </tr>
                                        <?php
                                        }
