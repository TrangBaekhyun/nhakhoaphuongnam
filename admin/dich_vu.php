            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Quản trị dịch vụ</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="index.php">Trang quản trị</a></li>
                            <li class="breadcrumb-item active">Quản trị dịch vụ</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-header">
                                <i class="fas fa-table me-1"></i>
                                Danh sách dịch vụ | <a href="dich_vu_them_moi.php"> Thêm mới</a>
                            </div>
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        $i = 0;
                                        while ($row = mysqli_fetch_array($dich_vu))
                                        {
                                            $i++;
                                        ;?>
                                        <tr>
                                            ...
                                            <td style="text-align: center;"><a href="dich_vu_sua.php?id=<?php echo $row["id_dich_vu"];?>">Sửa</a></td>
                                            <td style="text-align: center;"><a href="dich_vu_xoa.php?id=<?php echo $row["id_dich_vu"];?>">Xóa</a></td>
                                        </tr>
                                         <?php
                                        }
