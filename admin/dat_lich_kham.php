                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                      ...
                                      //4. Hiên thị ra dữ liệu vừa lấy
                                        $i=0;
                                        while($row = mysqli_fetch_array($dat_lich))
                                        {
                                            $i++;
                                          ;?>
                                        <tr>
                                            <td style="text-align: center"><?php echo $i ;?></td>
                                            <td><?php echo $row["id_dat_lich"] ;?></td>
                                            <td><?php echo $row["ho_ten"] ;?></td>
                                            <td><?php echo $row["email"] ;?></td>
                                            <td><?php echo $row["sđt"] ;?></td>
                                            <td><?php echo $row["id_co_so"] ;?></td>
                                            <td><?php echo $row["ngay"] ;?></td>
                                            <td><?php echo $row["thoi_gian"] ;?></td>
                                            <td style="text-align: center"><a href="dat_lich_kham_chi_tiet.php?id=<?php echo $row["id_dat_lich"];?>">Chi tiết</a></td>
                                            <td style="text-align: center"><a href="dat_lich_kham_xoa.php?id=<?php echo $row["id_dat_lich"];?>">Xóa</a></td>
                                        </tr>
                                        <?php
                                        }
