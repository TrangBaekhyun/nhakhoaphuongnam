    ...
    <body class="sb-nav-fixed">
        ...
        <div class="card-body">
          <div class="section-body">
            <div class="row">
              <div class="col-12 col-md-6 col-lg-6">
                <div class="card">
                  ...
                  <div class="card-body">
                  <form method="POST" action="khach_hang_sua_thuc_hien.php" enctype="multipart/form-data">
                    <div class="form-group">
                      <label>Mã khách hàng</label>
                      <input class="form-control" id="inputHoten" type="text" name="txtMakh"
                      value="<?php echo $row["id_khach_hang"];?>" />
                    </div>
                    <div class="form-group">
                     ...
                     <div class="form-group">
                      ...
                      <input type="text" class="form-control invoice-input" id="inputGioitinh" name="txtGioitinh"
                      value="<?php echo $row["gioi_tinh_kh"];?>" />
                    </div>
            ...
            <div class="mt-4 mb-0">
                <input type="hidden" name="txtID" value="<?php echo $row["id_khach_hang"];?>">
