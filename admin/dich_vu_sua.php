        ...
        <div id="layoutSidenav">
            ...
            <?php 
               ...
               $ket_noi = mysqli_connect("localhost", "root","", "nhakhoaphuongnam_db");
                ...
                $row = mysqli_fetch_array($dich_vu);
            ;?>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Cập nhật dịch vụ</h3></div>
                                    <div class="card-body">
                                        <form method="POST" action="dich_vu_sua_thuc_hien.php" enctype="multipart/form-data">
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="txtTenDichVu" name="txtTenDichVu" placeholder="Tên dịch vụ" value="<?php echo $row["ten_dich_vu"];?>"/>
                                                <label for="txtTenDichVu">Tên dịch vụ</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="txtDonVi" name="txtDonVi" placeholder="Đơn vị" value="<?php echo $row["don_vi"];?>"/>
                                                <label for="txtDonVi">Đơn vị</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="txtChiPhi" name="txtChiPhi" placeholder="Chi phí" value="<?php echo $row["chi_phi"];?>"/>
                                                <label for="txtChiPhi">Chi phí (VNĐ)</label>
                                            </div>
                                            <div class="mt-4 mb-0">
                                                <input type="hidden" name="txtID" value="<?php echo $row["id_dich_vu"];?>">
