...
<html lang="en">
  <head>
    <title>KIẾN THỨC | NHA KHOA PHƯƠNG NAM</title>
    <meta charset="utf-8">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
      <div class="container">
        <a class="navbar-brand" href="index.php">Phương Nam<span>Dentistry</span></a>
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item active"><a href="trang_chu.php" class="nav-link">Trang chủ</a></li>
            ...
            <li class="nav-item cta"><a href="lien_he.php" class="nav-link" data-toggle="modal" data-target="#modalRequest"><span>Đặt lịch hẹn</span></a></li>
          </ul>
        </div>
      </div>
    </nav>
    ...
    <section class="home-slider owl-carousel">
      <div class="slider-item bread-item" style="background-image: url('images/bg_1.jpg');" data-stellar-background-ratio="0.5">
        ...
        <div class="container" data-scrollax-parent="true">
          <div class="row slider-text align-items-end">
            <div class="col-md-7 col-sm-12 ftco-animate mb-5">
              <p class="breadcrumbs" data-scrollax=" properties: { translateY: '70%', opacity: 1.6}"><span class="mr-2"><a href="index.php">Trang chủ</a></span> <span>Kiến thức</span></p>
              <h1 class="mb-3" data-scrollax=" properties: { translateY: '70%', opacity: .9}">Kiến thức nha khoa tổng hợp được tư vấn bởi chuyên gia</h1>
            </div>
            </div>
          </div>
        </div>
		...
		<section class="ftco-section">
            ...
            <h2 class="mb-3">Implant dùng để làm gì?</h2>
            <p>Implant dùng chân răng nhân tạo cắm chặt trong xương, để làm trụ nâng đỡ các mão phục hình, các cầu răng và các phục hình tháo lắp (lọai bán hàm hay loại toàn hàm). Răng mới này có hình dáng và chức năng tương tự như các răng thật. Trường hợp mất 1 răng, nhiều răng, thậm chí mất răng toàn hàm do tai nạn, bệnh tật hoặc do bị thiếu răng bẩm sinh đều có thể được giải quyết bằng phương pháp cấy ghép implant.</p>
            <p>
              <img src="images/image_4.jpg" alt="" class="img-fluid">
            </p>
            <p>Trường hợp mất một răng duy nhất, giải pháp tốt nhất là làm một mão phục hình trên implant, như vậy không phải làm một cầu răng cổ điển, tác động lên các răng kế cận.</p>
            <h2 class="mb-3 mt-5">Cấy ghép implant thay thế nhiều răng mất liên tiếp</h2>
            <p>Trong trường hợp bạn bị mất nhiều răng, việc làm và mang một phục hình tháo lắp bán phần khiến bạn cảm thấy rất phiền phức? Implant làm trụ nâng đỡ cầu răng, thay thế cho các răng đã mất sẽ giúp bạn tìm lại được sự vui thích khi ăn, nhai, cảm thấy tư tin trong khi cười, chúng có đầy đủ các chức năng và hình dáng bên ngoài y như các răng thật.</p>
            <p>
              <img src="images/image_5.jpg" alt="" class="img-fluid">
            </p>
            <h2 class="mb-3 mt-5">Cấy ghép implant thay thế toàn bộ các răng</h2>

            <p>Nếu toàn bộ các răng trên một hàm bị mất, giải pháp cổ điển thường là làm một phục hình toàn hàm. Nay nhờ có phương pháp cấy ghép implant, toàn bộ hàm răng giả được cố định vào hàm, tạo sự vững chắc ổn định và ngăn ngừa tình trạng tiêu xương so với dùng hàm giả tháo lắp.</p>
            
            <div class="tag-widget post-tag-container mb-5 mt-5">
              <div class="tagcloud">
                <a href="#" class="tag-cloud-link">Sâu Răng</a>
                <a href="#" class="tag-cloud-link">Cấy Răng</a>
                <a href="#" class="tag-cloud-link">Niềng Răng</a>
                <a href="#" class="tag-cloud-link">Làm sạch</a>
              </div>
            </div>
            ...
            <div class="sidebar-box">
              <form action="#" class="search-form">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder=" Nhập một từ khóa cần tìm">
                </div>
              </form>
            </div>
            <div class="sidebar-box ftco-animate">
              ...
              <h3>Hạng mục</h3>
                <li><a href="#">Làm trắng răng <span>(12)</span></a></li>
                <li><a href="#">Cấy răng<span>(22)</span></a></li>
                <li><a href="#">Trồng răng <span>(37)</span></a></li>
                <li><a href="#">Cạo vôi răng <span>(42)</span></a></li>
                <li><a href="#">Răng bị sâu <span>(14)</span></a></li>
              </div>
            </div>
