...
<html lang="en">
  <head>
    <title>Nha khoa Phương Nam | Bài viết</title>
    <meta charset="utf-8">
    ...
    <section class="home-slider owl-carousel">
      <div class="slider-item bread-item" style="background-image: url('images/bg_1.jpg');" data-stellar-background-ratio="0.5">
		...
		<section class="ftco-section">
            ...
            <h2 class="mb-3">Mọi người thường băn khoăn với việc liệu tẩy trắng răng có hiệu quả không? Có an toàn không?</h2>
            <p> Các nghiên cứu lâm sàng cho thấy hiệu quả của việc tẩy trắng răng thường đạt mức độ trung bình răng sáng lên 9 bậc (dựa theo bảng so màu chuẩn của hệ thống vita), tuy nhiên điều này cũng tùy thuộc vào tính chất men răng và cơ địa của từng người.</p>

            <p>Thống kê cho thấy 95% dân số đáp ứng rất tốt với chất tẩy trắng răng và đạt được màu sắc mong muốn, và còn 5% không may mắn là sẽ không đáp ứng hoặc đáp ứng rất kém. Kinh nghiệm lâm sàng cho thấy  những người đáp ứng kém thường trả màu trở lại cũng nhanh hơn bình thường. Đa số những trường hợp này thường là các ca nhiễm màu tetracycline quá nặng.</p>
            <p>
